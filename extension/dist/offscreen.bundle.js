    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        ...
        case 2:
          ...
          modelUrl = chrome.runtime.getURL('models/mental-health-bert-finetuned-onnx/model_optimized.onnx');
          sessionPromise = onnxruntime_web__WEBPACK_IMPORTED_MODULE_0__.InferenceSession.create(modelUrl, {
            executionProviders: ['wasm']
          });
          sessionPromise.then(function () {
            return console.log('[P.A.T.C.H] ONNX session ready (mental-health-bert) in offscreen document');
          })["catch"](function (err) {
...
function argMax(arr) {
  return arr.reduce(function (bestIdx, x, i, a) {
    return x > a[bestIdx] ? i : bestIdx;
  }, 0);
}
...
/* harmony export */ });
/* harmony import */ var _vendor_wink_tokenizer_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./vendor/wink-tokenizer.mjs */ "./src/vendor/wink-tokenizer.mjs");
function _toConsumableArray(r) { return _arrayWithoutHoles(r) || _iterableToArray(r) || _unsupportedIterableToArray(r) || _nonIterableSpread(); }
function _nonIterableSpread() { throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function _unsupportedIterableToArray(r, a) { if (r) { if ("string" == typeof r) return _arrayLikeToArray(r, a); var t = {}.toString.call(r).slice(8, -1); return "Object" === t && r.constructor && (t = r.constructor.name), "Map" === t || "Set" === t ? Array.from(r) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? _arrayLikeToArray(r, a) : void 0; } }
function _iterableToArray(r) { if ("undefined" != typeof Symbol && null != r[Symbol.iterator] || null != r["@@iterator"]) return Array.from(r); }
...
/* harmony export */   TRACE_EVENT_BEGIN: () => (/* binding */ wt),
/* harmony export */   TRACE_EVENT_END: () => (/* binding */ _t),
/* harmony export */   TRACE_FUNC_BEGIN: () => (/* binding */ Ne),
/* harmony export */   TRACE_FUNC_END: () => (/* binding */ Me),
/* harmony export */   Tensor: () => (/* binding */ Ke),
/* harmony export */   "default": () => (/* binding */ sT),
/* harmony export */   env: () => (/* binding */ ye),
/* harmony export */   registerBackend: () => (/* binding */ kt)
/* harmony export */ });
/*!
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/offscreen.js");
/******/ 	
/******/ })()
;
